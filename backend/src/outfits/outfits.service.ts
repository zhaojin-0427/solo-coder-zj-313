...
export class OutfitsService {
  private outfits: Outfit[] = [
    {
      ...
      coverImage: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=ethereal%20bride%20in%20white%20lolita%20dress%20with%20lace%20veil%20and%20gold%20wig%20dreamy%20cloud%20theme%20wedding%20photoshoot&image_size=portrait_4_3',
      status: 'active',
      rentalCount: 8,
    ...
    },
    {
      ...
      coverImage: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=elegant%20rose%20theme%20lolita%20dress%20burgundy%20velvet%20choker%20rose%20hat%20birthday%20party&image_size=portrait_4_3',
      status: 'active',
      rentalCount: 12,
    ...
    },
    {
      ...
      coverImage: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=pirate%20adventure%20lolita%20outfit%20black%20coat%20tricorn%20hat%20skull%20accessories%20anime%20convention&image_size=portrait_4_3',
      status: 'active',
      rentalCount: 6,
    ...
    },
    {
      ...
      coverImage: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cat%20tea%20party%20lolita%20dress%20cat%20ear%20headband%20bell%20necklace%20mary%20jane%20shoes%20pastel&image_size=portrait_4_3',
      status: 'active',
      rentalCount: 15,
  ...
  create(createOutfitDto: CreateOutfitDto): Outfit {
    ...
    const newOutfit: Outfit = {
      ...
      items,
      rentalSlots,
      coverImage: createOutfitDto.coverImage || '',
